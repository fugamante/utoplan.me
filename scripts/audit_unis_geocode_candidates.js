...
function main() {
  ...
  fs.writeFileSync(OUTPUT_PATH, JSON.stringify({
    ...
    nextDecision: 'Use the reviewed narrow alias/campus decisions in data/unis/ipeds-alias-campus-review.json to build the Census geocoder cache for approved rows and keep the quarantine artifact aligned for excluded rows before marking unis import-ready.'
  }, null, 2) + '\n');
