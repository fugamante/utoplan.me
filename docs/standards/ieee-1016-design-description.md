...
| Reviewed signal-upgrade artifacts | `data/profile-reach/aguada-restaurant-permit-path-review.json` | Record bounded reviewed evidence upgrades for individual decision signals without expanding API/UI scope or turning process-path evidence into recommendations. |
