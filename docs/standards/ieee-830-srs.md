...
| FR-018 | The product shall keep reviewed decision-signal upgrades as descriptive evidence artifacts that cite official Puerto Rico authorities and explicit interpretation limits. | `data/profile-reach/aguada-restaurant-permit-path-review.json`, `data/profile-reach/aguada-restaurant-utility-service-review.json`, and `data/profile-reach/aguada-restaurant-site-screening-review.json` record reviewed upgrades for the Aguada restaurant regulatory, infrastructure, and site-feasibility signals, while `npm run test:regulatory-signal-review`, `npm run test:infrastructure-signal-review`, and `npm run test:site-feasibility-signal-review` verify their authority stacks, fixed-selection linkage, and descriptive-only limits. |
...
| FR-018 | Reviewed decision-signal evidence upgrades | `docs/product-scope.md`, `docs/data-intake.md`, `data/profile-reach/aguada-restaurant-permit-path-review.json`, `data/profile-reach/aguada-restaurant-utility-service-review.json`, `data/profile-reach/aguada-restaurant-site-screening-review.json`, `npm run test:regulatory-signal-review`, `npm run test:infrastructure-signal-review`, `npm run test:site-feasibility-signal-review` |
