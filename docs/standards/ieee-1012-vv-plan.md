...
| Planned profile/reach model | `docs/business-location-decision-framework.md`, `docs/product-scope.md`, `data/profile-reach/business-profile-reach-v1.json` | IEEE 1016 SDD profile/reach contract boundary | `npm run test:profile-reach-contract` proving the three-scenario matrix before profile-dependent fixture expansion |
