...
Add anonymous session/profile data-access and token-hashing scaffolding before implementing `POST /v1/anonymous-sessions` or caller-owned `/v1/profile` routes.
