...
- Replace ad hoc browser globals only after the existing map/data behavior is covered.
...
Continue Phase 4 by reducing remaining browser globals behind small modules.
