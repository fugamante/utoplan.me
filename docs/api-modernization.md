...
Add the anonymous storage migration design and threat-reviewed runtime sequence before implementing anonymous profile routes under `dtoapi/modern/src/`. Test migration to TypeScript is optional and lower priority than product behavior or CI hardening.
