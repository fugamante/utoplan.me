...
- `dtoapi/modern/test/anonymous_endpoint_handlers_test.js` pins pure anonymous create/read handler composition without wiring success runtime into `server.ts`.
